...
namespace Microsoft.ReactNative.Managed
{
  ...
  public static class JSValueReaderOf<T>
  {
    private static ReadValueDelegate<T> s_readValue = null;

    public static ReadValueDelegate<T> ReadValue
    {
      get { return s_readValue ?? (s_readValue = JSValueReader.GetReadValueDelegate<T>()); }
      set { s_readValue = value; }
    }
  }
}
