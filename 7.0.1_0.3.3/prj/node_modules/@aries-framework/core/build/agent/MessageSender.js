...
let MessageSender = class MessageSender {
    ...
    async sendMessage(outboundMessageContext, options) {
        ...
        const shouldAddReturnRoute = ((_e = message.transport) === null || _e === void 0 ? void 0 : _e.returnRoute) === undefined && !this.transportService.hasInboundEndpoint(ourDidDocument);
        try {
            // Loop trough all available services and try to send the message
            ...
            try {
                if (!_f && !_a && (_b = services_2.return)) await _b.call(services_2);
            }
