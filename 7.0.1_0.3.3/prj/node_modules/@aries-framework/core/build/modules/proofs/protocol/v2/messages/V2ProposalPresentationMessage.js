...
class V2ProposalPresentationMessage extends AgentMessage_1.AgentMessage {
    constructor(options) {
        var _a, _b;
        super();
    ...
    getAttachmentFormats() {
        ...
        this.formats.forEach((format) => {
            ...
            if (!attachment) {
                throw new AriesFrameworkError_1.AriesFrameworkError(`Could not find a matching attachment with attachmentId: ${format.attachmentId}`);
            }
...
//# sourceMappingURL=V2ProposalPresentationMessage.js.map