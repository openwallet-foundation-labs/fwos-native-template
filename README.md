...
## Native Template Version 7.0.6 - AFJ 0.4.1 - Android

This native template is located in directory `7.0.6_0.4.1` in this source tree.
...
```
## Native Template Version 7.0.6 - AFJ 0.4.1 - iOS
...
## Native Template Version 7.0.1 - AFJ 0.4.1 - Android

This native template is located in directory `7.0.1_0.4.1` in this source tree.
...
npm install react-native-argon2 --save
```
## Native Template Version 7.0.1 - AFJ 0.4.1 - iOS
